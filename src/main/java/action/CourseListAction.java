...
import vo.PageInfo;
 ...
 public class CourseListAction implements Action {
	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		int listCount=courseListService.getListCount(); //총 리스트 수를 받아옴.
		courseList = courseListService.getCourseList(page,limit); //리스트를 받아옴.
		//총 페이지 수.
		...
		ActionForward forward= new ActionForward();
   		forward.setPath("/course/course_list.jsp");
   		return forward;
